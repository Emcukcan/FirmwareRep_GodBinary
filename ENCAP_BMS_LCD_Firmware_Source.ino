...
void setup() {
  ...
  if (SerialNumber.substring(0, 11) == "EN02048V064"  ||   SerialNumber.substring(0, 12) == "ES01048V06a4" || SerialNumber.substring(0, 12) == "ES01048V06A4" ||   SerialNumber.substring(0, 12) == "ES01048V0343") {
  ...
  else if (SerialNumber.substring(0, 3) == "ENS"  || SerialNumber.substring(0, 3) == "ECS") {
    CompanyMod = 4;  //ENSEGA
  }
  ...
  else if (SerialNumber.substring(0, 3) == "ELL" || SerialNumber.substring(0, 3) == "ECL") {
  ...
  for (;;) {
    ...
    if (!SDReset) {
      ...
      if (ceil(OpSec) >= 25 && ceil(OpSec) <= 26 ) {
        ...
        String Address = "/BMS_" + String(rtc.days) + "_" + String(rtc.months) + "_" + String(rtc.years) + "-" + SerialNumber.substring(SerialNumber.length() - 5) + ".xls";
        String DailyVoltageAddress = "/Stat_" + String(rtc.days) + "_" + String(rtc.months) + "_" + String(rtc.years) + "-" + SerialNumber.substring(SerialNumber.length() - 5) + "_Voltage.xls";
        String DailyTemperatureAddress = "/Stat_" + String(rtc.days) + "_" + String(rtc.months) + "_" + String(rtc.years) + "-" + SerialNumber.substring(SerialNumber.length() - 5) + "_Temperature.xls";
        String HourlyDischargeAddress = "/Stat_" + String(rtc.days) + "_" + String(rtc.months) + "_" + String(rtc.years) + "-" + SerialNumber.substring(SerialNumber.length() - 5) + "Discharge.xls";
        String HourlyChargeAddress = "/Stat_" + String(rtc.days) + "_" + String(rtc.months) + "_" + String(rtc.years) + "-" + SerialNumber.substring(SerialNumber.length() - 5) + "Charge.xls";

        // Serial.println(Address);



        String SDCard_row[50];
        ...
        // if (String(rtc.years).toInt() >= 2010 && abs((BMS.current - 30000) * 0.1) < 400 && abs(BMS.max_cell_temp - 40) < 100) {

        if (String(rtc.years).toInt() >= 2010 ) {
          ...
          VoltageArray[String(rtc.hours).toInt()] = BMS.sum_voltage;
          for (int i = 0; i < 24; i++) {
            VoltageArrayString[i] = String(VoltageArray[i]) ;
          ...
          TemperatureArray[String(rtc.hours).toInt()] = (BMS.max_cell_temp - 40) * 10;
          for (int i = 0; i < 24; i++) {
          ...
          //
          //
          HourlyDischargeArray[String(rtc.hours).toInt()] = HourlyDischargeEnergy;
          // HourlyDischargeArray[String(rtc.hours).toInt()] = 89;
          for (int i = 0; i < 24; i++) {
          ...
          //
          HourlyChargeArray[String(rtc.hours).toInt()] = HourlyChargeEnergy;
          ...
          if (String(rtc.years).toInt() > 2010 && String(rtc.hours).toInt() == 0 && (String(rtc.minutes).toInt() > 2 && String(rtc.minutes).toInt() < 5)) { // Reset Voltage Data for the new day
            for (int i = 0; i < 24; i++) {
          ...
          if ((String(rtc.minutes).toInt() == 0 && String(rtc.years).toInt() > 2010 )) {
    ...
    if (landingDone) {
      ...
      if (PreviousDay != String(rtc.days) && PreviousDay != "") {
        //Serial.println("PreviousDay:" + PreviousDay);
        // Serial.println("RTC DAY:" + String(rtc.days));
        MaxTemp1 = 0;
        MaxTemp2 = 0;
        MaxVoltage = 0;
        MinVoltage = 500;
  ...
  for (;;) {
    ...
    if (SerialBT.available()) {
      ...
      if (param_start != -1 && param_end != -1) {
        ...
        if (SimMode) {
          MEAS1 = "TV" + String(SIM_SUM) +  "/TC" + String(SIM_CURRENT) + "/SOC" +  String(SIM_SOC) + "/TEMP" +  String(SIM_TEMP) +
                  "/MAX" + String(SIM_MAXCELL) + "/MIN" + String(SIM_MIN_CELL) +  "/STT" + String(BMS.state) +
                  "/CH" + String(BMS.charge) + "/DSH" + String(BMS.discharge) + "/LF" + String(BMS.bms_life) +
                  "/RC" + String(BMS.rem_cap);
        }

        else {
          MEAS1 = "TV" + String(BMS.sum_voltage * 0.1) +  "/TC" + String((BMS.current - 30000) * 0.1) + "/SOC" +  String(BMS.SOC * 0.1) + "/TEMP" +  String(BMS.max_cell_temp - 40) +
                  "/MAX" + String(BMS.max_cell_volt * 0.001) + "/MIN" + String(BMS. min_cell_volt * 0.001) +  "/STT" + String(BMS.state) +
                  "/CH" + String(BMS.charge) + "/DSH" + String(BMS.discharge) + "/LF" + String(BMS.bms_life) +
                  "/RC" + String(BMS.rem_cap);
        }
      ...
      if (param_start != -1 && param_end != -1) {
        ...
        MEAS2 = "/BL" + String(balancerState) + "/CHE" + String(ChargeEnergy, 3) + "/DHE" + String(DischargeEnergy) + "/TM" + TimeString + "/DT" + DateString +
      ...
      if (param_start != -1 && param_end != -1) {
        ...
        for (int i = 0; i < ReadCellMod; i++) {
          CellString = CellString + String(CellValues[i]) + "/";
        }
...
void BMS_COMM_CODE( void * pvParameters ) {
  ...
  for (;;) {
        ...
        && (!CVD_CAL) && (!SafetyTurnOnApproved) && (!SafetyTurnOffApproved) && (!CURRENT_CAL) && (!SERIAL_CAL) && (!CURRENT_ZERO_CAL) && (!SetCANID) && (!SetEnergies) && (!SetCOMM))
    {
      ...
      if (String(rtc.seconds).length() < 2) {
        calibratedSecond = "0" + String(rtc.seconds);
      }
      else {
        calibratedSecond = String(rtc.seconds);
      }
      ...
      //gpio 1&2 is for charge and dicharge
      //gpio is for sleeping
    ...
    else  //Parameter Set
    {
      ...
      //SOC
        ...
        for (int i = 0; i < 5; i++) {
          ...
          CommandStatus = set_soc_BMS(SystemSOC, (String(rtc.years).substring(2)).toInt(), String(rtc.months).toInt(), String(rtc.days).toInt(), String(rtc.hours).toInt(), String(rtc.minutes).toInt(), String(rtc.seconds).toInt());

          Serial.println("settted rtc");
          Serial.println((String(rtc.years).substring(2)).toInt());
          Serial.println(String(rtc.months).toInt());
          Serial.println(String(rtc.days).toInt());
          Serial.println(String(rtc.hours).toInt());
          Serial.println(String(rtc.minutes).toInt());
          Serial.println(String(rtc.seconds).toInt());
          Serial.println("------------settted rtc------------");
...
void FIREBASE_CODE( void * pvParameters ) {
  ...
  for (;;) {
    ...
    if (  ( (OpSec > 43 && OpSec < 45) ) && OpMin > 0 && a % 10 == 0) {
      //      String FirebaseTimeStamp = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/TimeStamp";
      //      String FirebaseFirmwareVersion = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/Firmware";
      //      String FirebaseTerminalVoltage = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/TerminalVoltage";
      //      String FirebaseTerminalCurrent = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/TerminalCurrent";
      //      String FirebaseCellTemp = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/CellTemp";
      //      String FirebaseStateOfCharge = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/StateOfCharge";
      //      String FirebaseMaxCell = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/MaxCell";
      //      String FirebaseMinCell = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/MinCell";
      //      String FirebaseChargeEnergy = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/ChargeEnergy";
      //      String FirebaseDischargeEnergy = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/DischargeEnergy";
      //      String FirebaseRestartCounter = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/RestartCounter";
      //      String FirebaseMaxCurrent = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/MaxCurrent";
      //      String FirebaseMinCurrent = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/MinCurrent";
      //      String FirebaseAlarm = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/Alarm";
      //      String FirebaseSD = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/SD";

      String FirebaseData1 = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/Data1";
      String FirebaseData2 = "/Monitoring/ENCAP2024_1/" + SerialNumber + "/YEAR" + String(rtc.years) + "/MONTH" + String(rtc.months) + "/DAY" + String(rtc.days) + "/HOUR" + String(rtc.hours) + "/Data2";
    ...
    if (ts.touched()) {
      ...
      if (PageNumber == 0) {
        ...
        if (!action_done && y >= 62 && y <= 222 && x >= 0 && x <= 239) {
          ...
          if (CompanyMod == 4 && dashboard_page == 6) {
            dashboard_page = 7;
            Serial.println("!!!!");
          }
...
//  Serial.print(bmsCounter);
  ...
  Serial.print(String(rtc.months).toInt());
  Serial.print("RTC_DAY:");
  Serial.print(String(rtc.days).toInt());
  Serial.print("RTC_HOUR:");
  Serial.print(String(rtc.hours).toInt());
  Serial.print("RTC_MIN:");
  Serial.print(String(rtc.minutes).toInt());
  Serial.print("RTC_SEC:");
  Serial.print(String(rtc.seconds).toInt());
...
void drawDashboard(int SOC, float MaxVolt, float MinVolt, float MaxDiff, float TerminalVolt, float TerminalCurr, float TerminalTemp) {
  ...
  if (SerialNumber.substring(0, 3) == "ENL" || SerialNumber.substring(0, 3) == "ELL" || SerialNumber.substring(0, 3) == "ECL") {
  ...
  if ( dashboard_page == 0) {
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if (VoltageArray[i] != 0 && String(rtc.years) != "2000") {
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if (TemperatureArray[i] != 0 && String(rtc.years) != "2000") {
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if (HourlyDischargeArray[i] != 0 && String(rtc.years) != "2000") {
    ...
    for (int i = 0; i < 24; i++) {
      ...
      if (HourlyChargeArray[i] != 0 && String(rtc.years) != "2000") {
